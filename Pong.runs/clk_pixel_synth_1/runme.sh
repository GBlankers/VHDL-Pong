...
HD_PWD='C:/Users/gblan/OneDrive/Documenten/Vivado_projects/Pong/Pong.runs/clk_pixel_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_pixel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_pixel.tcl
